...
final class Version20260214175857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media_image (id INT AUTO_INCREMENT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, owner VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NOT NULL, product_id INT DEFAULT NULL, page_id INT DEFAULT NULL, INDEX IDX_DA24C0EE4584665A (product_id), INDEX IDX_DA24C0EEC4663E4 (page_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NOTNULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
