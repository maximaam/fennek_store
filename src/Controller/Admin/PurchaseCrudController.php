...
use App\Controller\Admin\Filter\PurchasePaymentFilter;
...
final class PurchaseCrudController extends AbstractCrudController
{
    ...
    {
        return $filters
            ->add(PurchasePaymentFilter::new('name', 'purchase.payer.lastname'))
            ->add(PurchasePaymentFilter::new('email_address', 'purchase.payer.email'))
            ->add(
